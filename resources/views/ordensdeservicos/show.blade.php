        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('ordensdeservicos.index') }}">Ordens de serviços</a></li>
                    <li class="breadcrumb-item active">OS: {{ $order->id }}</li>
                </ol>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="clearfix">
                    ...
                    <div class="float-end">
                        <h3 class="d-print-none">OS: 195{{ $order->id }}</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="clearfix pt-3">
                            ...
                            <small>
                                Todas as contas devem ser pagas no prazo de 7 dias a partir do 
                                recebimento da fatura. A ser pago em cheque ou cartão de crédito ou 
                                pagamento direto online. 
                            </small>
                        </div>
                    </div> <!-- end col -->
                    <div class="col-sm-6">
