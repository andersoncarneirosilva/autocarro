...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ url('site/img/favicon.ico') }}" rel="icon">
    ...
    <div class="container-fluid bg-primary text-white d-none d-lg-flex wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-3">
            <div class="d-flex align-items-center">
                <a href="index.html">
                    <h2 class="text-white fw-bold m-0">AUTOCAR</h2>
                </a>
                <div class="ms-auto d-flex align-items-center">
                    <small class="ms-4"><i class="fa fa-map-marker-alt me-3"></i>R. 24 de Agosto, 864 - Centro, Esteio - RS</small>
                    {{-- <small class="ms-4"><i class="fa fa-envelope me-3"></i>contato@autocar.com.br</small> --}}
                    <small class="ms-4"><i class="fa fa-phone-alt me-3"></i>(51) 99999.9999</small>
                    ...
                    <a href="#" class="text-white"><small class="ms-4"><i class="fa fa-user-alt me-3"></i>ACESSAR</small></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="index.html" class="navbar-brand d-lg-none">
                    <h1 class="fw-bold m-0">AUTOCAR</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="about.html" class="nav-item nav-link">Novos</a>
                        <a href="service.html" class="nav-item nav-link">Semi-novos</a>
                        <a href="service.html" class="nav-item nav-link">Usados</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Especiais</a>
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a href="feature.html" class="dropdown-item">Classícos</a>
                                <a href="team.html" class="dropdown-item">Esportivos</a>
                                <a href="testimonial.html" class="dropdown-item">Modificados</a>
                            </div>
                        </div>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="0" class="active"
                    ...
                    <img class="img-fluid" src="site/img/carousel-1.jpg" alt="Image">
                </button>
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="1" aria-label="Slide 2">
                    <img class="img-fluid" src="site/img/carousel-2.jpg" alt="Image">
                </button>
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="2" aria-label="Slide 3">
                    <img class="img-fluid" src="site/img/carousel-3.jpg" alt="Image">
                </button>
            </div>
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="site/img/carousel-3.jpg" alt="Image">
                    <div class="carousel-caption">
                        <h1 class="display-1 text-uppercase text-white mb-4 animated zoomIn">Best Metalcraft Solutions
                        </h1>
                        <a href="#" class="btn btn-primary py-3 px-4">Explore More</a>
