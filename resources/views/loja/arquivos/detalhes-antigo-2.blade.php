...
<section class="container py-5 mt-5">
    <nav class="flex items-center gap-2 text-xs md:text-sm text-muted-foreground mb-4 md:mb-6 overflow-x-auto"><a class="hover:text-primary transition-colors" href="/">Início</a><span>/</span><a class="hover:text-primary transition-colors" href="/comprar">Comprar</a><span>/</span><span class="text-foreground">fiat mobi 1.0 evo flex like. manual</span></nav>
