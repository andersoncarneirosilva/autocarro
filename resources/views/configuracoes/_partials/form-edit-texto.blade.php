<div class="modal fade" id="editTextoFinalModal" tabindex="-1" aria-labelledby="editInfoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="editFormTextoFinal" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea  id="edit_text_final" class="form-control" rows="6"  name="texto_final"></textarea>
                    </div>
                </div>
