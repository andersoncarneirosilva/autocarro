    ...
    <div class="col-6 text-end">
        <button type="button" class="btn btn-sm btn-primary" onclick="openProcModal(event, {{ $veiculo->id }})">
                                            ...
                                            <button type="button" class="btn btn-sm btn-secondary" disabled>
                                                <i class="mdi mdi-file-outline me-1"></i> ATPVE
                                            </button>
                                            @else
...
<p class="text-muted mb-2 mt-2 font-13"><strong>Procuração</strong></p>
...
<p class="text-muted mb-2 mt-2 font-13"><strong>Solicitação ATPVE</strong></p>
