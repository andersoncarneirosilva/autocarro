...
use App\Models\DocVeiculo;
class DocVeiculoController extends Controller
{
    protected $model;

    public function __construct(DocVeiculo $docs)
    {
        $this->model = $docs;
    }
    ...
    public function index(Request $request){
        ...
        $docs = DocVeiculo::paginate(10);
        //dd($docs);
        return view('doc_veiculo.index', compact('docs'));
    }
